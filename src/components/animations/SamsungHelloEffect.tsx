...
/**
 * SVG path-draw animation spelling "xin chào" in a Samsung Bold Tech aesthetic.
 * Each stroke draws in sequence with spring physics. Futuristic accent lines
 * sweep in after all letters complete.
 *
 * Usage:
 *   <SamsungHelloVietnameseEffect speed={0.8} onAnimationComplete={() => ...} />
 *
 * Props:
 *   speed            — multiplier on all durations/delays (default 1). Lower = faster.
 *   onAnimationComplete — fires when the final path finishes animating.
 *   className        — forwarded to the <svg> root (default height h-32).
 */
...
/**
 * SVG path-draw animation spelling "hello" in a Samsung Bold Tech aesthetic.
 * Angular letterforms with corner bracket accent elements.
 *
 * Usage:
 *   <SamsungHelloEnglishEffect speed={0.8} onAnimationComplete={() => ...} />
 *
 * Props:
 *   speed            — multiplier on all durations/delays (default 1). Lower = faster.
 *   onAnimationComplete — fires when the final bracket finishes animating.
 *   className        — forwarded to the <svg> root (default height h-28).
 */
